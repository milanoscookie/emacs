...
(map! [remap evil-jump-to-tag] #'projectile-find-tag
	  ...
	  ;; LANGUAGE COMMANDS
	  ;; :i "C-f" #'yas-insert-snippet
	  (:prefix "\\"
		(:prefix "q"
			:nv "q" #'sx-tab-all-questions
			:nv "i" #'sx-inbox
			:nv "o" #'sx-open-link
			:nv "u" #'sx-tab-unanswered-my-tags
			:nv "a" #'sx-ask
			:nv "s" #'sx-search
		  )
		(:prefix "r"
		...
		(:after elixir-mode
		  (:prefix "r"
		  :nv "l" #'alchemist-eval-current-line
		  :nv "a" #'alchemist-eval-buffer
		  :nv "r" #'alchemist-eval-region
		  :nv "c" #'alchemist-compile
		  )
		  :nv "m" #'alchemist-mix
		)
		(:after tuareg-mode
		  (:prefix "r"
		  :nv "l" #'tuareg-eval-phrase
		  :nv "a" #'tuareg-eval-buffer
		  :nv "s" #'tuareg-eval-region
		  )
		  )
		;; TODO FIX MERLIN SUPPORT
		;; :nv "t" #'merlin
		:nv "d" #'merlin-destruct
		:nv "l" #'merlin-locate
		(:prefix "c"
		  :nv "i" #'comment-line
		  :nv "r" #'comment-region
